...
namespace Mondays.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", "Ο κωδικός επαλήθευσης δεν είναι έγκυρος.");
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            _logger.LogInformation("Ο χρήστης με αναγνωριστικό '{UserId}' έχει ενεργοποιήσει το 2FA με μια εφαρμογή ελέγχου ταυτότητας.", userId);

            StatusMessage = "Η εφαρμογή ελέγχου ταυτότητας έχει επαληθευτεί.";
