    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                var callbackUrl = "https://www.mondays.gr/Identity/Account/ConfirmEmailChange";

                // append userId and confirmation code as parameters to the url
                callbackUrl += String.Format("?userId={0}&code={1}", user.Id, HttpUtility.UrlEncode(code));
                ...
                StatusMessage = "Σύνδεσμος επιβεβαίωσης για αλλαγή της αποστολής email. Παρακαλούμε ελέγξτε το email σας.";
                return RedirectToPage();
            }

            StatusMessage = "Το email σας είναι αμετάβλητο.";
            return RedirectToPage();
        }
